...
struct MctsGraphOfConvexSetsOptions {
...
/**
MctsGraphOfConvexSets (GCS) implements the design pattern and optimization problems
...
or infinite graphs, by deriving from ImplicitMctsGraphOfConvexSets.

@ingroup geometry_optimization
*/
class MctsGraphOfConvexSets {
 public:
  DRAKE_NO_COPY_NO_MOVE_NO_ASSIGN(MctsGraphOfConvexSets);
  ...
  MctsGraphOfConvexSets() = default;

  virtual ~MctsGraphOfConvexSets();
  ...
  class Vertex final {
   ...
   private:
    ...
    friend class MctsGraphOfConvexSets;
  };
  ...
  once it's needed.
  */
  std::unique_ptr<MctsGraphOfConvexSets> Clone() const;
  ...
  */
  solvers::MathematicalProgramResult SolveShortestPath(
      ...
      const MctsGraphOfConvexSetsOptions& options =
          MctsGraphOfConvexSetsOptions()) const;
  ...
  */
  ...
  std::vector<const Edge*> GetMctsSolutionPath(
      const Vertex& source, const Vertex& target,
      const solvers::MathematicalProgramResult& result,
      double tolerance = 1e-3) const;
  ...
  */
  solvers::MathematicalProgramResult SolveConvexRestriction(
      ...
      const MctsGraphOfConvexSetsOptions& options = MctsGraphOfConvexSetsOptions(),
