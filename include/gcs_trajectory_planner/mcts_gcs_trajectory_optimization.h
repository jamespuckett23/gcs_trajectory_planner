...
// define a new class that is based off the original GCS trajectory planner class. 
// This class will overload certain functions and utilize many common features

//TODO
// 1. Functions to update:
//  - SolvePath
// 2. Implement MCTS in a function in the new GcsTrajectory_optimization
//  - Maybe rename: MCTS_GcsTrajectory_optimization

namespace drake {
namespace planning {
namespace trajectory_optimization {

class MctsGcsTrajectoryOptimization final {
    public:
    DRAKE_NO_COPY_NO_MOVE_NO_ASSIGN(MctsGcsTrajectoryOptimization);
     ...
     @param num_positions is the dimension of the configuration space.
        ...
        */
        explicit MctsGcsTrajectoryOptimization(
            int num_positions,
            std::vector<int> continuous_revolute_joints = std::vector<int>());

        ~MctsGcsTrajectoryOptimization();
     ...
     regions and edges between them based on intersection. From an API standpoint,
        ...
        subgraphs. Note that the the MctsGraphOfConvexSets does not differentiate between
        ...
        */
        ...
        const std::vector<geometry::optimization::MctsGraphOfConvexSets::Vertex*>&
        Vertices() {
            return vertices_;
        }
        ...
        std::vector<const geometry::optimization::MctsGraphOfConvexSets::Vertex*>
        Vertices() const;

        /** Returns constant reference to a vector of mutable pointers to the
         edges. */
        const std::vector<geometry::optimization::MctsGraphOfConvexSets::Edge*>&
        Edges() {
            return edges_;
        }
        ...
        /** Returns pointers to the edges stored in the subgraph.
         @exclude_from_pydrake_mkdoc{This overload is not bound in pydrake.} */
        std::vector<const geometry::optimization::MctsGraphOfConvexSets::Edge*> Edges()
            const;
        ...
        */
        ...
        MctsGraphOfConvexSets::Transcription, while adding a convex surrogate to the
        relaxation. For more details, see @ref nonconvex_graph_of_convex_sets
        "Guiding Non-convex Optimization with the MctsGraphOfConvexSets".
        ...
        */
        ...
        appropriate "convex surrogate" that is supported within MctsGraphOfConvexSets,
        or exclusively using the SolveConvexRestriction method. */
        void AddVertexCost(
            const symbolic::Expression& e,
            const std::unordered_set<
                geometry::optimization::MctsGraphOfConvexSets::Transcription>&
                use_in_transcription = {
                    geometry::optimization::MctsGraphOfConvexSets::Transcription::kMIP,
                    geometry::optimization::MctsGraphOfConvexSets::Transcription::
                        kRelaxation,
                    geometry::optimization::MctsGraphOfConvexSets::Transcription::
                        kRestriction});
        ...
        MctsGraphOfConvexSets, or exclusively using the SolveConvexRestriction method.
        */
        ...
        */
        ...
        T SubstituteVertexPlaceholderVariables(
            T e,
            const geometry::optimization::MctsGraphOfConvexSets::Vertex& vertex) const;

        /* Substitute any placeholder variables with the versions corresponding to
        a specific internal edge. The return type will match the argument type. */
        template <typename T>
        T SubstituteEdgePlaceholderVariables(
            T e, const geometry::optimization::MctsGraphOfConvexSets::Edge& edge) const;
        ...
        MctsGcsTrajectoryOptimization& traj_opt_;

        std::vector<geometry::optimization::MctsGraphOfConvexSets::Vertex*> vertices_;
        std::vector<geometry::optimization::MctsGraphOfConvexSets::Edge*> edges_;
        ...
        friend class MctsGcsTrajectoryOptimization;
        };
     ...
     given subgraphs. These edges are a subset of the many other edges in the
        ...
        in the MctsGraphOfConvexSets framework, thus mixing it with other instances of
     ...
     @param from_subgraph is the subgraph to connect from. Must have been created
        ...
        require constraints that are not yet supported by the MctsGraphOfConvexSets::Edge
     ...
     shortest path problem on the whole graph. @see
        `geometry::optimization::MctsGraphOfConvexSets::SolveShortestPath()` for further
        details.
        ...
        @see `geometry::optimization::MctsGraphOfConvexSetsOptions` for further details.
        */
        std::pair<trajectories::CompositeTrajectory<double>,
                solvers::MathematicalProgramResult>
        SolvePath(
            const Subgraph& source, const Subgraph& target,
            const geometry::optimization::MctsGraphOfConvexSetsOptions& options = {});
        ...
        See geometry::optimization::MctsGraphOfConvexSets::SolveConvexRestriction().
        This API prefers a sequence of vertices over edges, as a user may know which
        regions the solution should pass through.
        MctsGcsTrajectoryOptimization::AddRegions() automatically manages edge creation
        ...
        SolveConvexRestriction(
            const std::vector<
                const geometry::optimization::MctsGraphOfConvexSets::Vertex*>&
                active_vertices,
            const geometry::optimization::MctsGraphOfConvexSetsOptions& options = {});
     ...
     GCS mathematical program, for regression testing purposes.
        ...
        /** Getter for the underlying MctsGraphOfConvexSets. This is intended primarily
     for inspecting the resulting programs. */
        const geometry::optimization::MctsGraphOfConvexSets& graph_of_convex_sets()
            const {
        return gcs_;
        }
     ...
     Reconstructs the path r(s) from the solution trajectory q(t) of
        ...
        */
        ...
        MctsGcsTrajectoryOptimization for robotic systems with continuous revolute joints
        ...
        MctsGcsTrajectoryOptimization::SolvePath() is a CompositeTrajectory of
        BezierCurves.
        */
    ...
    private:
        ...
        geometry::optimization::MctsGraphOfConvexSets::Edge* AddEdge(
            geometry::optimization::MctsGraphOfConvexSets::Vertex* u,
            geometry::optimization::MctsGraphOfConvexSets::Vertex* v);

        geometry::optimization::MctsGraphOfConvexSets gcs_;

        // Store the subgraphs by reference.
        std::vector<std::unique_ptr<Subgraph>> subgraphs_;
        std::vector<std::unique_ptr<EdgesBetweenSubgraphs>> subgraph_edges_;
        std::map<const geometry::optimization::MctsGraphOfConvexSets::Vertex*, Subgraph*>
            vertex_to_subgraph_;
